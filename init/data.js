...
// Exporting the sampleListings array to be used in the init/index.js file to seed the database with sample data when the application is started.
// exporting an object with a key data that holds the value of sampleListings
